...
export function MobileStickyCTA() {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-white/10 bg-background/95 backdrop-blur-md p-3 pb-safe lg:hidden">
            <Link href={HONEYBOOK_URL} target="_blank" className="block w-full">
                <Button className="w-full h-12 text-sm uppercase tracking-widest font-bold rounded-none shadow-[0_0_20px_rgba(245,230,202,0.25)] bg-accent text-surface hover:bg-accent-hover">
                    Secure a Date
                </Button>
            </Link>
        </div>
